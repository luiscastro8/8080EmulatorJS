export default class State8080 {
  ...
  public setA = (num: number) => {
    this.eightBitRegisters[0] = num;
  };

  public setB = (num: number) => {
    this.eightBitRegisters[1] = num;
  };

  public setC = (num: number) => {
    this.eightBitRegisters[2] = num;
  };

  public setD = (num: number) => {
    this.eightBitRegisters[3] = num;
  };

  public setE = (num: number) => {
    this.eightBitRegisters[4] = num;
  };

  public setH = (num: number) => {
    this.eightBitRegisters[5] = num;
  };
