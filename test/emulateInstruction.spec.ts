...
describe("emulate instructions", () => {
  ...
  beforeEach(() => {
    ...
    CALLSpy = jest.spyOn(repeatableInstuctions, "CALL");
  });
  ...
  test("0x0c", () => {
    ...
    const after = () => {
      expect(setFlagsSpy).toBeCalled();
      expect(state.c).toBe(0x32);
    };
    testInstruction(state, 0x0c, 1, 5, before, after);
  });
  ...
  test("0x12", () => {
    ...
    const after = () => {
      expect(state.memory[HILO(state.d, state.e)]).toBe(0x22);
    };
    testInstruction(state, 0x12, 1, 7, before, after);
  });
  ...
  test("0x14", () => {
    ...
    testInstruction(state, 0x14, 1, 5, before, after);
  });
  ...
  test("0x15", () => {
    ...
    const after = () => {
      expect(state.d).toBe(0xff);
      expect(setFlagsSpy).toBeCalled();
    };
    testInstruction(state, 0x15, 1, 5, before, after);
  });
  ...
  test("0x22", () => {
    const before = () => {
      ...
      state.memory[state.pc + 2] = 0x30;
    };
    const after = () => {
      expect(state.memory[0x3032]).toBe(0x20);
      expect(state.memory[0x3033]).toBe(0x22);
    };
    testInstruction(state, 0x22, 3, 16, before, after);
  });
  ...
  test("0x2c", () => {
    ...
    testInstruction(state, 0x2c, 1, 5, before, after);
  });
  ...
  test("0x34", () => {
    const before = () => {
      state.h = 0x20;
      state.l = 0x21;
      state.memory[HILO(state.h, state.l)] = 0x25;
    };
    const after = () => {
      expect(state.memory[0x2021]).toBe(0x26);
    };
    testInstruction(state, 0x34, 1, 10, before, after);
  });
  ...
  test("0x3c", () => {
    ...
    const after = () => {
      expect(setFlagsSpy).toBeCalled();
      expect(state.a).toBe(0x08);
    };
    testInstruction(state, 0x3c, 1, 5, before, after);
  });
  ...
  test("0x48", () => {
    ...
    const after = () => {
      expect(state.c).toBe(0x05);
    };
    testInstruction(state, 0x48, 1, 5, before, after);
  });
  ...
  test("0x4e", () => {
    const before = () => {
      state.h = 0x20;
      state.l = 0x22;
      state.memory[0x2022] = 0x05;
    };
    const after = () => {
      expect(state.c).toBe(0x05);
    };
    testInstruction(state, 0x4e, 1, 7, before, after);
  });
  ...
  test("0x61", () => {
    ...
    const after = () => {
      expect(state.h).toBe(0x04);
    };
    testInstruction(state, 0x61, 1, 5, before, after);
  });
  ...
  test("0x65", () => {
    ...
    const after = () => {
      expect(state.h).toBe(0x25);
    };
    testInstruction(state, 0x65, 1, 5, before, after);
  });
  ...
  test("0x68", () => {
    ...
    testInstruction(state, 0x68, 1, 5, before, after);
  });
  ...
  test("0x69", () => {
    ...
    testInstruction(state, 0x69, 1, 5, before, after);
  });
  ...
  test("0x71", () => {
    ...
    const after = () => {
      expect(state.memory[HILO(state.h, state.l)]).toBe(0x43);
    };
    testInstruction(state, 0x71, 1, 7, before, after);
  });
  ...
  test("0x83", () => {
    ...
    testInstruction(state, 0x83, 1, 4, before, after);
  });
  ...
  test("0x85", () => {
    ...
    testInstruction(state, 0x85, 1, 4, before, after);
  });
  ...
  test("0x8a", () => {
    ...
    testInstruction(state, 0x8a, 1, 4, before, after);
  });
  ...
  test("0xa0", () => {
    ...
    const after = () => {
      expect(state.a).toBe(0b00010001);
    };
    testInstruction(state, 0xa0, 1, 4, before, after);
  });
  ...
  test("0xa6", () => {
    const before = () => {
      ...
      state.h = 0x20;
      state.l = 0x21;
      state.memory[HILO(state.h, state.l)] = 0b00110011;
    };
    const after = () => {
      expect(state.a).toBe(0b00010001);
    };
    testInstruction(state, 0xa6, 1, 7, before, after);
  });
  ...
  test("0xbe", () => {
    const before = () => {
      ...
      state.h = 0x20;
      state.l = 0x21;
      state.memory[HILO(state.h, state.l)] = 0x07;
    };
    const after = () => {
      expect(setFlagsSpy).toBeCalled();
    };
    testInstruction(state, 0xbe, 1, 7, before, after);
  });
  ...
  describe("0xcc", () => {
    test("cc.z is true", () => {
      ...
      testInstruction(state, 0xcc, undefined, 18, before, after);
    });
    ...
    test("cc.z is false", () => {
      ...
      testInstruction(state, 0xcc, 3, 11, before, after);
    });
  });
  ...
  test("0xcd", () => {
    ...
    testInstruction(state, 0xcd, undefined, 17, undefined, after);
  });
  ...
  describe("0xfa", () => {
    test("cc.s is true", () => {
      ...
      testInstruction(state, 0xfa, undefined, 15, before, after);
    });
